...
public class Question extends BaseTimeEntity {
    ...
    private List<Answer_option> answer_options = new ArrayList<>();
    ...
    //== 연관관계 메서드 ==//
    public void addOption(Answer_option option) {
        answer_options.add(option);
        option.setQuestion(this);
    }

    //==생성 메서드==//
    public static Question createQuestion(Long question_num, String title, String type, int option_count, Answer_option... answer_options) {
        ...
        for(Answer_option answer_option: answer_options) {
            question.addOption(answer_option);
        }
